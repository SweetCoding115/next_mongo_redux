      ...
      <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-indigo-900">
        ...
        <div className="w-full py-6 z-20">
          ...
          <div className="flex justify-center py-6 space-x-2">
            ...
            <div onClick={() => signIn()} style={{cursor:'pointer'}} className='flex flex-col items-center justify-center'>
              <Image src={googleSvg} alt="My SVG" width={30} height={30} color='white'/>
              <p style={{fontWeight:'bold'}}>Google</p>
            </div>
            <a href={facebookLoginUrl} style={{ filter:'invert(0.4)', cursor:'pointer'}} onClick={() => signIn("facebook")} className='flex flex-col items-center justify-center pointer-events-none'>
          ...
          <form onSubmit={handleSubmit} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            ...
            <div className="text-right text-slate-400 hover:underline hover:text-slate-100">
